...
check_page(void)
{
	...
	cprintf("va = %p, ptep = %p, ptep1 = %p, ptx(va) = %p \n",va, ptep, ptep1, PTX(va));
	cprintf("va = %d, ptep = %d, ptep1 = %d, ptx(va) = %d \n",va, ptep, ptep1, PTX(va));
